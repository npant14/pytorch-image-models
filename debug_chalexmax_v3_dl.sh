...
sh distributed_stu_dl.sh 2 train_skeleton_dl.py \
    ...
    --model $model \
    --model-kwargs ip_scale_bands=$scale_bands classifier_input_size=$classifier_input_size hmax_type=alexmax_v3_4  contrastive_loss=True\
    --cl-lambda 1\
    --opt sgd \
    -b 128 \
    --epochs 90 \
    ...
    --experiment debug3_noaug_resize2_{$model}_cl_1_ip_{$scale_bands}_322_{$classifier_input_size}_dl\
