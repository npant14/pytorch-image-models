...
def load_chresmax_v3_2(layername=None):
    ...
    model = create_model(
        'chresmax_v3_2',
        pretrained='/oscar/data/tserre/xyu110/pytorch-output/train/0/final_versions/ip_3_chresmax_v3_2_gpu_8_cl_0.1_ip_3_322_322_18432_c1[_6,3,1_]_bypass/model_best.pth.tar',
        num_classes=1000,
        in_chans=3,
        **kwargs
    )
...
def load_alexnet(layername=None):
    model = create_model(
        'alexnet',
        pretrained='/oscar/data/tserre/xyu110/pytorch-output/train/0/baseline_w_aug/ip_0_alexnet_gpu_2_cl_0_ip_3_322_322_0_c1[_6,3,1_]_scale_0.08/model_best.pth.tar',
        num_classes=1000,
        in_chans=3,
    )
    layers = dict([*model.named_modules()]).keys()
...
def load_resnet18(layername=None):
    model = create_model(
        'resnet18',
        pretrained='/oscar/data/tserre/xyu110/pytorch-output/train/0/baseline_w_aug/ip_0_resnet18_gpu_8_cl_0_ip_3_322_322_512_c1[_6,3,1_]_scale_0.08/model_best.pth.tar',
        num_classes=1000,
        in_chans=3,
    )
    layers = dict([*model.named_modules()]).keys()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', type=str, default="hmax_old", 
                       choices=['hmax_old', 'chresmax_v3_bypass_only', 'chresmax_v3_2', 'alexnet', 'resnet18'],
