...
# ./submit_job.sh chresmax_v2 3 0.5 9216 8 32 False "120:00:00"
# ./submit_job.sh chresmax_v2 3 0.5 18432 8 32 True "144:00:00"

./submit_job.sh contrastive_resmax 3 0 9216 1 4 False "96:00:00" True
...
# do
#     ./val_job.sh contrastive_resmax 3 1 9216 2 32 False $imgscale "1:00:00"
# done