...
# ./submit_job.sh chresmax_v3_2 3 0.1 18432 8 16 True "192:00:00" 0.01 gpu
...
# ./submit_job.sh chresmax_v3_bypass_only 11 0.55 4096 8 4 True "48:00:00" 0.001 gpu 1.0 224

# for cl_lambda in $(seq 0.505 0.005 0.545); do
#     # ./submit_job.sh chresmax_v3_bypass_only 11 $cl_lambda 4096 8 4 True "48:00:00" 0.001 gpu 1.0 224
#     ./val_job.sh chresmax_v3_bypass_only 11 $cl_lambda 4096 1 64 True "112 134 158 188 224 266 316 376 448" "1:00:00" "/oscar/data/tserre/xyu110/pytorch-output/train/0/mnist/ip_11_chresmax_v3_bypass_only_gpu_8_cl_${cl_lambda}_ip_3_224_224_4096_c1[_6,3,1_]_bypass"
# done
# 
...
# ./submit_job.sh chresmax_v3_bypass_only_o 18 0.65 9216 8 4 True "48:00:00" 0.005 gpu 1.0 224
# ./submit_job.sh hmax_old_deep 18 0.5 0000 8 4 True "48:00:00" 0.001 gpu 1.0 224
# ./submit_job.sh hmax_new_tricks 18 0.5 0000 8 4 True "24:00:00" 0.001 gpu 1.0 224
# ./submit_job.sh hmax_old_s1_c_scoring 18 0.5 0000 8 4 True "24:00:00" 0.005 gpu 1.0 224
...
###### JULY 15th ######
# ./val_job.sh chresmax_v3 3 0.2 18432 1 128 True "160 192 227 270 322 382 454" "1:00:00" "/oscar/data/tserre/xyu110/pytorch-output/train/0/chresmax_v3_lambda/ip_3_chresmax_v3_gpu_8_cl_0.2_ip_3_322_322_18432_c1[_6,3,1_]_bypass"


###### JULY 22th ######
# ./val_job.sh chresmax_v3_2 3 0.1 18432 1 128 True "160 192 227 270 322 382 454" "1:00:00" "/oscar/data/tserre/xyu110/pytorch-output/train/5/ip_3_chresmax_v3_2_gpu_8_cl_0.1_ip_3_322_322_18432_c1[_6,3,1_]_bypass"

# ./val_job.sh chresmax_v3_2_abs 3 0.1 18432 1 64 True "160 192 227 270 322 382 454" ":00:00" "/oscar/data/tserre/xyu110/pytorch-output/train/5/ip_3_chresmax_v3_2_abs_gpu_8_cl_0.1_ip_3_322_322_18432_c1[_6,3,1_]_bypass" 
...
# ./val_job.sh chresmax_v3_2_abs 3 0.1 18432 1 64 True "160 192 227 270 322 382 454" "3:00:00" "/oscar/data/tserre/xyu110/pytorch-output/train/0/models_wo_aug/ip_3_chresmax_v3_2_abs_gpu_8_cl_0.1_ip_3_322_322_18432_c1[_6,3,1_]_bypass" 

# ./val_job.sh chresmax_v3_a_2 3 0.1 18432 1 64 True "160 192 227 270 322 382 454" "3:00:00" "/oscar/data/tserre/xyu110/pytorch-output/train/0/models_wo_aug/ip_3_chresmax_v3_a_2_gpu_8_cl_0.1_ip_3_322_322_18432_c1[_6,3,1_]_bypass"  
...
# ./val_job.sh hmax_old 18 0.5 0000 1 32 True "112 134 158 188 224 266 316 376 448" "local" "/oscar/data/tserre/xyu110/pytorch-output/train/0/mnist/ip_18_hmax_old_gpu_1_cl_0.5_ip_3_224_224_0000_c1[_6,3,1_]_bypass_1" &

# ./val_job.sh hmax_old 18 0.5 0000 1 32 True "634 896 1268 1792" "local" "/oscar/data/tserre/xyu110/pytorch-output/train/0/mnist/ip_18_hmax_old_gpu_1_cl_0.5_ip_3_224_224_0000_c1[_6,3,1_]_bypass_1" &

# "112 134 158 188 224 266 316 376 448 634 896 1268 1792" "1:00:00"

# ./val_job.sh hmax_old_deep 18 0.5 0000 1 8 True "112 134 158 188 224 266 316 376 448 634 896 1268 1792" "1:00:00" "/oscar/data/tserre/xyu110/pytorch-output/train/0/mnist/ip_18_hmax_old_deep_gpu_2_cl_0.5_ip_3_224_224_0000_c1[_6,3,1_]_bypass_11"

# ./val_job.sh hmax_new_tricks 18 0.5 0000 1 8 True "112 134 158 188 224 266 316 376 448 634 896 1268 1792" "1:00:00" "/oscar/data/tserre/xyu110/pytorch-output/train/0/mnist/ip_18_hmax_new_tricks_gpu_8_cl_0.5_ip_3_224_224_0000_c1[_6,3,1_]_bypass_1"
...
# ./val_job.sh chresmax_v3_2_abs 18 1 15616 1 64 True "112 134 158 188 224 266 316 376 448" "local" "/oscar/data/tserre/xyu110/pytorch-output/train/0/models_wo_aug/ip_3_chresmax_v3_2_abs_gpu_8_cl_0.1_ip_3_322_322_18432_c1[_6,3,1_]_bypass" &

# ./val_job.sh chresmax_v3_bypass_only 11 0.5 4096 1 64 True "112 134 158 188 224 266 316 376 448" "local" "/oscar/data/tserre/xyu110/pytorch-output/train/0/mnist/ip_11_chresmax_v3_bypass_only_gpu_8_cl_0.5_ip_3_224_224_4096_c1[_6,3,1_]_bypass" &
...
# ./val_job.sh chresmax_abs_bypass_only 16 0.55 9216 1 64 True "112 134 158 188 224 266 316 376 448" "1:00:00" "/oscar/data/tserre/xyu110/pytorch-output/train/0/mnist/ip_16_chresmax_abs_bypass_only_gpu_8_cl_0.55_ip_3_224_224_9216_c1[_6,3,1_]_bypass" &

# ./val_job.sh chresmax_v3_bypass_only 18 0.5 4096 1 32 True "112 134 158 188 224 266 316 376 448" "1:00:00" "/oscar/data/tserre/xyu110/pytorch-output/train/0/mnist/ip_18_chresmax_v3_bypass_only_gpu_8_cl_0.5_ip_3_224_224_4096_c1[_6,3,1_]_bypass_1"

# ./val_job.sh chresmax_v3_bypass_only 11 0.55 4096 1 64 True "112 134 158 188 224 266 316 376 448" "1:00:00" "/oscar/data/tserre/xyu110/pytorch-output/train/0/mnist/ip_11_chresmax_v3_bypass_only_gpu_8_cl_0.55_ip_3_224_224_4096_c1[_6,3,1_]_bypass"

# ./val_job.sh chresmax_v3_bypass_only_tiny 11 0.5 7776 1 64 True "112 134 158 188 224 266 316 376 448" "1:00:00" "/oscar/data/tserre/xyu110/pytorch-output/train/0/mnist/ip_11_chresmax_v3_bypass_only_tiny_gpu_2_cl_0.5_ip_3_224_224_7776_c1[_6,3,1_]_bypass"

# ./val_job.sh chresmax_v3_bypass_only_o 18 0.1 9216 1 32 True "112 134 158 188 224 266 316 376 448" "local" "/oscar/data/tserre/xyu110/pytorch-output/train/mnist/ip_18_chresmax_v3_bypass_only_o_gpu_8_cl_0.1_ip_3_224_224_9216_c1[_6,3,1_]_bypass" &

# ./val_job.sh chresmax_v3_bypass_only 11 0.5 4096 1 64 True "112 134 158 188 224 266 316 376 448" "1:00:00" "/oscar/data/tserre/xyu110/pytorch-output/train/mnist/ip_11_chresmax_v3_bypass_only_gpu_8_cl_0.5_ip_3_224_224_4096_c1[_6,3,1_]_bypass"