...
sh distributed_stu_dl.sh 8 train_skeleton_dl.py \
    ...
    --start-epoch 101\
    --initial-checkpoint /users/irodri15/data/irodri15/Hmax/pytorch-image-models/output/train/6_25/debug10.3_balanced_scale_{$model}_bypass_cl_{$cl_lambda}_ip_{$scale_bands}_322_{$classifier_input_size}/model_best.pth.tar\
    --experiment debug10.3_balanced_scale_{$model}_bypass_cl_{$cl_lambda}_ip_{$scale_bands}_322_{$classifier_input_size}\
    --output /users/irodri15/data/irodri15/Hmax/pytorch-image-models/output/train/6_25/\
